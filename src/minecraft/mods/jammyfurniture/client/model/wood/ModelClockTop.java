...
public class ModelClockTop extends ModelBase implements JFIModel {
	...
	ModelRenderer[] clockCadrans = new ModelRenderer[6];
	ModelRenderer top1;
	ModelRenderer top4;
	ModelRenderer top3;
	ModelRenderer top2;
	...
	private void initClockCadran () {
		
		for (int i = 0; i < this.clockCadrans.length; i++) {

			this.clockCadrans[i] = new ModelRenderer(this, 48, 9+i*6);
			this.clockCadrans[i].addBox(1.0F, 1.0F, 0.0F, 8, 6, 0);
			this.clockCadrans[i].setRotationPoint(-5.0F, 12.0F, -5.0F);
			this.clockCadrans[i].setTextureSize(8, 6);
			this.clockCadrans[i].mirror = true;
			this.setRotation(this.clockCadrans[i], 0.0F, 0.0F, 0.0F);
		}
	}
	...
	public void renderCadrant (float f1) {
		this.clockCadrans[0].render(f1);
//		this.clockCadrans[1].render(f1);
//		this.clockCadrans[2].render(f1);
//		this.clockCadrans[3].render(f1);
//		this.clockCadrans[4].render(f1);
//		this.clockCadrans[5].render(f1);
	}
