...
public class TileEntityCeramicBlocksOne extends TileEntity implements IInventory {
	...
	public TileEntityCeramicBlocksOne(int meta) {
		md = meta;
	}
	...
	public ItemStack decrStackSize(int par1, int par2) {
		if (this.bathroomCupboardContents[par1] != null) {
			...
			if (this.bathroomCupboardContents[par1].stackSize <= par2) {
				itemstack1 = this.bathroomCupboardContents[par1];
				this.bathroomCupboardContents[par1] = null;
				this.onInventoryChanged();
				return itemstack1;
			} else {
				itemstack1 = this.bathroomCupboardContents[par1].splitStack(par2);
	...
	public void readFromNBT(NBTTagCompound par1NBTTagCompound) {
		...
		this.bathroomCupboardContents = new ItemStack[this.getSizeInventory()];
