...
public class jfm_Recipes extends ModJammyFurniture {
	public static void initRecipes() {
		...
		GameRegistry.addRecipe(new ItemStack(blockMiscBlocksOne, 1, 8), new Object[] { "ABC", "GDR", "SWS", 'W', Block.wood, 'S', Block.stone, 'R', Item.redstone, 'G', Item.glowstone, 'A', new ItemStack(Block.cloth, 1, 14), 'B', new ItemStack(Block.cloth, 1, 3), 'C', new ItemStack(Block.cloth, 1, 1),
