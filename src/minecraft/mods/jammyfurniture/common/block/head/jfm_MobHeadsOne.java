...
public class jfm_MobHeadsOne extends BlockContainer {
	...
	public jfm_MobHeadsOne(int id, int notsure, Class teClass) {
	...
	public int idDropped(int i, Random random, int j) {
		return ModJammyFurniture.blockMobHeadsOne.blockID;
	}
	...
	public AxisAlignedBB getCollisionBoundingBoxFromPool(World par1World, int par2, int par3, int i) {
		...
		if (b == 0) {
			this.setBlockBounds(0.3F, 0.3F, 0.6F, 0.7F, 0.8F, 1.0F);
		} else if (b == 1) {
			this.setBlockBounds(0.0F, 0.3F, 0.3F, 0.4F, 0.8F, 0.7F);
		} else if (b == 2) {
			this.setBlockBounds(0.3F, 0.3F, 0.0F, 0.7F, 0.8F, 0.4F);
		} else if (b == 3) {
			this.setBlockBounds(0.6F, 0.3F, 0.3F, 1.0F, 0.8F, 0.7F);
		} else if (b == 4) {
			this.setBlockBounds(0.25F, 0.25F, 0.625F, 0.75F, 0.75F, 1.0F);
		} else if (b == 5) {
			this.setBlockBounds(0.0F, 0.25F, 0.25F, 0.375F, 0.75F, 0.75F);
		} else if (b == 6) {
			this.setBlockBounds(0.25F, 0.25F, 0.0F, 0.75F, 0.75F, 0.375F);
		} else if (b == 7) {
			this.setBlockBounds(0.625F, 0.25F, 0.25F, 1.0F, 0.75F, 0.75F);
		} else if (b == 8) {
			...
			this.setBlockBounds(0.2F, 0.05F, 0.1F, 0.8F, 0.75F, 1.0F);
		} else if (b == 13) {
			this.setBlockBounds(0.0F, 0.05F, 0.2F, 0.9F, 0.75F, 0.8F);
		} else if (b == 14) {
			this.setBlockBounds(0.2F, 0.05F, 0.0F, 0.8F, 0.75F, 0.9F);
		} else if (b == 15) {
			this.setBlockBounds(0.1F, 0.05F, 0.2F, 1.0F, 0.75F, 0.8F);
		} else {
		...
		if (meta != 0 && meta != 1 && meta != 2 && meta != 3) {
			if (meta != 4 && meta != 5 && meta != 6 && meta != 7) {
				if (meta != 8 && meta != 9 && meta != 10 && meta != 11) {
					...
					par1World.playSound((double) par2, (double) par3, (double) par4, "random.fuse", 1.0F, 1.0F, true);
					return true;
				}
			} else {
				par1World.playSound((double) par2, (double) par3, (double) par4, "mob.cow.say", 1.0F, 1.0F, true);
				return true;
			}
		} else {
			par1World.playSound((double) par2, (double) par3, (double) par4, "mob.chicken.say", 1.0F, 1.0F, true);
			return true;
		}
	}
	...
	public TileEntity getBlockEntity() {
		return new TileEntityMobHeadsOne();
	}
