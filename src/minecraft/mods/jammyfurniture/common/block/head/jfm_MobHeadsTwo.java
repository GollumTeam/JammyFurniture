...
public class jfm_MobHeadsTwo extends BlockContainer
{
    ...
    public jfm_MobHeadsTwo(int id, int notsure, Class teClass)
    {
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World par1World, int par2, int par3, int i)
    {
        ...
        if (b == 0)
        {
            this.setBlockBounds(0.25F, 0.25F, 0.425F, 0.75F, 0.75F, 1.0F);
        }
        else if (b == 1)
        {
            this.setBlockBounds(0.0F, 0.25F, 0.25F, 0.575F, 0.75F, 0.75F);
        }
        else if (b == 2)
        {
            this.setBlockBounds(0.25F, 0.25F, 0.0F, 0.75F, 0.75F, 0.575F);
        }
        else if (b == 3)
        {
            this.setBlockBounds(0.425F, 0.25F, 0.25F, 1.0F, 0.75F, 0.75F);
        }
        else if (b == 4)
        {
            this.setBlockBounds(0.3F, 0.25F, 0.625F, 0.7F, 0.625F, 1.0F);
        }
        else if (b == 5)
        {
            this.setBlockBounds(0.0F, 0.25F, 0.3F, 0.375F, 0.625F, 0.7F);
        }
        else if (b == 6)
        {
            this.setBlockBounds(0.3F, 0.25F, 0.0F, 0.7F, 0.625F, 0.375F);
        }
        else if (b == 7)
        {
            this.setBlockBounds(0.625F, 0.25F, 0.3F, 1.0F, 0.625F, 0.7F);
        }
        else if (b == 8)
        {
        ...
        if (meta != 0 && meta != 1 && meta != 2 && meta != 3)
        {
            if (meta != 4 && meta != 5 && meta != 6 && meta != 7)
            {
                if (meta != 8 && meta != 9 && meta != 10 && meta != 11)
                {
                    ...
                    {
                        par1World.playSound((double)par2, (double)par3, (double)par4, "mob.spider.say", 1.0F, 1.0F, true);
                        return true;
                    }
                }
                else
                {
                    par1World.playSound((double)par2, (double)par3, (double)par4, "mob.skeleton.say", 1.0F, 1.0F, true);
                    return true;
                }
            }
            else
            {
                par1World.playSound((double)par2, (double)par3, (double)par4, "mob.sheep.say", 1.0F, 1.0F, true);
                return true;
            }
        }
        else
        {
            par1World.playSound((double)par2, (double)par3, (double)par4, "mob.pig.say", 1.0F, 1.0F, true);
            return true;
        }
    }
