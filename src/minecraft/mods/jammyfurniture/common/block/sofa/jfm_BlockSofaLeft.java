...
public class jfm_BlockSofaLeft extends BlockContainer {
	...
	public jfm_BlockSofaLeft(int id, int notsure, Class teClass) {
	...
	public int idDropped(int i, Random random, int j) {
		return ModJammyFurniture.blockSofaPartLeft.blockID;
	}
	...
	public int getRenderType() {
		return ModJammyFurniture.sofaPartLeftRenderID;
	}
	...
	public Icon getIcon(int side, int metadata) {
		return metadata <= 3 ? this.jfm_blockIconRed : (metadata >= 4 && metadata <= 7 ? this.jfm_blockIconBlue : (metadata >= 8 && metadata <= 11 ? this.jfm_blockIconGrey : this.jfm_blockIconGreen));
	}
}
