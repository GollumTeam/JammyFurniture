...
public class jfm_BlockSofaCenter extends BlockContainer {
	...
	public jfm_BlockSofaCenter(int id, int notsure, Class teClass) {
	...
	public int idDropped(int i, Random random, int j) {
		return ModJammyFurniture.blockSofaPartCenter.blockID;
	}
	...
	public int getRenderType() {
		return ModJammyFurniture.sofaPartCenterRenderID;
	}
	...
	public TileEntity getBlockEntity() {
		return new TileEntitySofaCenter();
	}
