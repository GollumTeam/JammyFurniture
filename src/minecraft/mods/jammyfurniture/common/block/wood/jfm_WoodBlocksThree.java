...
public class jfm_WoodBlocksThree extends BlockContainer
{
    ...
    public jfm_WoodBlocksThree(int id, int notsure, Class teClass)
    {
    ...
    {
        return i >= 8 ? JammyFurnitureModCore.woodBlocksOne.blockID : JammyFurnitureModCore.woodBlocksThree.blockID;
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        if (l != 0 && l != 1 && l != 2 && l != 3)
        {
            if (l != 4 && l != 5 && l != 6 && l != 7)
            {
                if (l == 8)
                {
                    par1World.setBlock(par2, par3, par4, JammyFurnitureModCore.woodBlocksThree.blockID, 12, 2);
                    return true;
                }
                else if (l == 9)
                {
                    par1World.setBlock(par2, par3, par4, JammyFurnitureModCore.woodBlocksThree.blockID, 13, 2);
                    return true;
                }
                else if (l == 10)
                {
                    par1World.setBlock(par2, par3, par4, JammyFurnitureModCore.woodBlocksThree.blockID, 14, 2);
                    return true;
                }
                else if (l == 11)
                {
                    par1World.setBlock(par2, par3, par4, JammyFurnitureModCore.woodBlocksThree.blockID, 15, 2);
                    return true;
                }
                else if (l == 12)
                {
                    par1World.setBlock(par2, par3, par4, JammyFurnitureModCore.woodBlocksOne.blockID, 9, 2);
                    return true;
                }
                else if (l == 13)
                {
                    par1World.setBlock(par2, par3, par4, JammyFurnitureModCore.woodBlocksOne.blockID, 10, 2);
                    return true;
                }
                else if (l == 14)
                {
                    par1World.setBlock(par2, par3, par4, JammyFurnitureModCore.woodBlocksOne.blockID, 11, 2);
                    return true;
                }
                else if (l == 15)
                {
                    par1World.setBlock(par2, par3, par4, JammyFurnitureModCore.woodBlocksOne.blockID, 12, 2);
                    return true;
                }
                else
                {
