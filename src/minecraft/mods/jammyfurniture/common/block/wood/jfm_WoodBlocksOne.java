...
public class jfm_WoodBlocksOne extends BlockContainer
{
    ...
    public jfm_WoodBlocksOne(int id, int notsure, Class c)
    {
    ...
    {
        return JammyFurnitureModCore.woodBlocksOne.blockID;
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer entityplayer, int par6, float par7, float par8, float par9)
    {
        ...
        jfm_TileEntityWoodBlocks teWoodBlocks;
        ...
        if (meta != 1 && meta != 2 && meta != 3 && meta != 4)
        {
            ...
            if (meta == 9)
            {
                par1World.setBlock(par2, par3, par4, JammyFurnitureModCore.woodBlocksThree.blockID, 8, 2);
                return true;
            }

            if (meta == 10)
            {
                par1World.setBlock(par2, par3, par4, JammyFurnitureModCore.woodBlocksThree.blockID, 9, 2);
                return true;
            }

            if (meta == 11)
            {
                par1World.setBlock(par2, par3, par4, JammyFurnitureModCore.woodBlocksThree.blockID, 10, 2);
                return true;
            }

            if (meta == 12)
            {
                par1World.setBlock(par2, par3, par4, JammyFurnitureModCore.woodBlocksThree.blockID, 11, 2);
                return true;
            }

            if (meta == 13)
            {
                teWoodBlocks = (jfm_TileEntityWoodBlocks)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        jfm_TileEntityWoodBlocks te = (jfm_TileEntityWoodBlocks)par1World.getBlockTileEntity(par2, par3, par4);
