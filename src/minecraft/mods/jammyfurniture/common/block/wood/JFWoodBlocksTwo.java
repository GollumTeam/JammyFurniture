...
public class JFWoodBlocksTwo extends BlockContainer {
	...
	public int idDropped(int i, Random random, int j) {
		return ModJammyFurniture.blockWoodBlocksTwo.blockID;
	}
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer entityplayer, int par6, float par7, float par8, float par9) {
		...
		if (meta != 0 && meta != 1 && meta != 2 && meta != 3) {
			if (meta == 4 || meta == 5 || meta == 6 || meta == 7) {
				teWoodBlocksTwo = (TileEntityWoodBlocksTwo) par1World.getBlockTileEntity(par2, par3, par4);

				if (teWoodBlocksTwo != null) {
					entityplayer.openGui(ModJammyFurniture.instance, 154, par1World, par2, par3, par4);
					return true;
				}
			}
		} else {
			...
			if (teWoodBlocksTwo != null) {
				entityplayer.openGui(ModJammyFurniture.instance, 153, par1World, par2, par3, par4);
				return true;
			}
		}
	...
	public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6) {
		TileEntityWoodBlocksTwo te = (TileEntityWoodBlocksTwo) par1World.getBlockTileEntity(par2, par3, par4);
